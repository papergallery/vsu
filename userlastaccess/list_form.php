...
class userlastaccess_form extends moodleform {
	public function definition() {
        ...
        $mform->addElement('static', title, 'Оисание',
            'Выберете параметры факультет и тип пользователя (Студент/Преподаватель). Нажмите "Отобразить список" для отображения списка пользователей.
             Для сохранения списка в файл сначала отобразите список, а затем нажмите "Сохранить список".');
